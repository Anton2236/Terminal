package com.axotsoft.blurminal2.slice;
...
import com.axotsoft.blurminal2.widget.WidgetClickReceiver;
...
public class CommandSliceProvider extends SliceProvider
{
    ...
    /**
     * Converts URL to content URI (i.e. content://com.axotsoft.blurminal2.slice...)
     */
    @Override
    @NonNull
    ...
    public Slice onBindSlice(Uri sliceUri)
    {
        ...
        else
        {
            ...
            return new ListBuilder(getContext(), sliceUri, ListBuilder.INFINITY)
                    .addRow(
                            new RowBuilder()
                                    .setTitle("Test").setPrimaryAction(getSliceAction(getContext()))
                    )
                    .build();
        }
    }
